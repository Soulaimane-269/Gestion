...
<html lang="en">
    <head>
        ...
        <link href="/application-master/src/sass/admin/accueil/accueil.css" rel="stylesheet">
    ...
    <body>
        <div class="container">
            <div class="button-holder1">
                <div>
                    <a href="../gaz/gestion-gaz/liste-des-utilisateurs" type="button" class="button-gaz boutton-gaz-getion btn btn-primary btn-lg">gaz</a>
